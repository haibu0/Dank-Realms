...
namespace common.resources
{
    ...
    public class Item
    {
        ...
        public readonly bool RangedSummon;
        ...
        public Item(ushort type, XElement e)
        {
            ...
            RangedSummon = e.HasElement("RangedSummon");
    ...
    public class ActivateEffect
    {
        ...
        public ActivateEffect(XElement e)
        {
            ...
            if (e.HasAttribute("color2"))
            {
                Color2 = e.GetAttribute<uint>("color2");
            }
            if (e.HasAttribute("useWisMod"))
            {
            ...
            if (e.HasAttribute("visualEffect"))
            {
