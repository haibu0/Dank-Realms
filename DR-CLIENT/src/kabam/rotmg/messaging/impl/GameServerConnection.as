                   ...
                   if (itemXML.Activate == "PowerStat") {
                       if (player.ascended_) {
                           ...
                           if (baseStat == stats[2] + postMaxOffset) {
                               this.addTextLine.dispatch(new AddTextLineVO("", "'" + itemXML.attribute("id") + "' not consumed." +
                           ...
                           this.addTextLine.dispatch(new AddTextLineVO("", "'" + itemXML.attribute("id") + "' consumed. " + consumeResult));
                       } else {
                           this.addTextLine.dispatch(new AddTextLineVO("", "You must have ascension enabled in order to consume vials." + player.ascended_));
                           SoundEffectLibrary.play("error");
                           return false;
                       }
                   }
      ...
      private function onShowEffect(showEffect:ShowEffect) : void
      {
         ...
         switch(showEffect.effectType_)
         {
            ...
            case ShowEffect.THROW_EFFECT_TYPE:
               ...
               e = new ThrowEffect(start,showEffect.pos1_.toPoint(),showEffect.color_, showEffect.airTime_);
