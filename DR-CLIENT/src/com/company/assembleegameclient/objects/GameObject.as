...
public class GameObject extends BasicObject
   {
      ...
      public var icons_:Vector.<BitmapData> = null;
      public var iconFills_:Vector.<GraphicsBitmapFill> = null;
      public var iconPaths_:Vector.<GraphicsPath> = null;
      ...
      public static function damageWithDefense(origDamage:int, targetDefense:int, armorPiercing:Boolean, targetCondition:int) : int
      {
         ...
         if((targetCondition & ConditionEffect.INVULNERABLE_BIT) != 0)
         {
          ...
          if((targetCondition & ConditionEffect.EXPOSED_BIT) != 0)
          {
              d *= 1.25;
          }
      ...
      public function isConfused() : Boolean
      {
       ...
       {
           return (this.condition_ & ConditionEffect.UNSTABLE_BIT) != 0;
       }
