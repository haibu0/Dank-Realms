...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        private readonly SV<bool> _admin;
        public bool Admin
        {
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            _ascensionEnabled = new SV<bool>(this, StatsType.AscensionEnabled, client.Character.AscensionEnabled, false);
        ...
        {
            if (AccountId != 1) //i want more pets
            {
                Pet?.Owner?.LeaveWorld(Pet);
                //if (pet id is same dont spawn)
            }
        ...
        void HandleRegen(RealmTime time)
        {
            ...
            {
                _hpRegenCounter += Stats.GetHPRegen() * time.ElaspedMsDelta / 500f;
            ...
            {
                _mpRegenCounter += Stats.GetMPRegen() * time.ElaspedMsDelta / 500f;
