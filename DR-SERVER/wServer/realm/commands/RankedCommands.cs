...
namespace wServer.realm.commands
{
    ...
    {
        public SetGoldCommand() : base("setgold", reqAdmin: true, alias: "gold") { }
    ...
    {
        public SetFameCommand() : base("setfame", reqAdmin: true, alias: "fame") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            player.Fame = player.Client.Account.Fame += amount;
    ...
    {
        public Max2Command() : base("maxop", reqAdmin: true) { }
    ...
    {
        public AscendCommand() : base("ascend", reqAdmin: true)
        {
        }
