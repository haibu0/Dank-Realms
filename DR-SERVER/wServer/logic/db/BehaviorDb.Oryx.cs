...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                ...
                new Threshold(0.0005,
                    new ItemLoot("Vial of Attack", 0.3),
                    new ItemLoot("Vial of Defense", 0.3),
                    new ItemLoot("Vial of Wisdom", 0.3),
                    new ItemLoot("Vial of Vitality", 0.3),
                    new ItemLoot("Vial of Dexterity", 0.3),
                    new ItemLoot("Vial of Life", 0.3),
                    new ItemLoot("Vial of Mana", 0.3),
                    new ItemLoot("Vial of Speed", 0.3)


                ),
                new Threshold(0.001,
                    new TierLoot(tier: 11, type: ItemType.Weapon, probability: .3),
                    new TierLoot(tier: 12, type: ItemType.Weapon, probability: .3),
                    new TierLoot(tier: 13, type: ItemType.Weapon, probability: .3),
                    new TierLoot(6, ItemType.Ability, .3),
                    new TierLoot(7, ItemType.Ability, .3),
                    new TierLoot(12, ItemType.Armor, .3),
                    new TierLoot(13, ItemType.Armor, .3),
                    new TierLoot(14, ItemType.Armor, .3),
                    new TierLoot(5, ItemType.Ring, .3)
                )
            )
        ...
        .Init("Oryx Gift",
                ...
                new Threshold(0.0005,
                    new TierLoot(tier: 12, type: ItemType.Weapon, probability: .1),
                    new TierLoot(tier: 13, type: ItemType.Weapon, probability: .1),
                    new TierLoot(tier: 14, type: ItemType.Weapon, probability: .1),
                    new TierLoot(6, ItemType.Ability, .1),
                    new TierLoot(7, ItemType.Ability, .1),
                    new TierLoot(8, ItemType.Ability, .1),
                    new TierLoot(12, ItemType.Armor, .1),
                    new TierLoot(13, ItemType.Armor, .1),
                    new TierLoot(14, ItemType.Armor, .1),
            ...
            .Init("Oryx the Mad God 1",
                new State(
                    new DropPortalOnDeath("Wine Cellar Portal", 100),
