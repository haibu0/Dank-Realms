package com.company.assembleegameclient.ui.tooltip.slotcomparisons
{
   public class PoisonComparison extends SlotComparison
   {
      ...
      override protected function compareSlots(itemXML:XML, curItemXML:XML) : void
      {
         ...
         {
             impactDamage = int(activate[0].@impactDamage);
            ...
            text = damage + " HP over " + duration + " secs within " + radius + " sqrs\n";
             text2 = impactDamage + " Damage on Impact\n";

             comparisonText = comparisonText + ("Poison Grenade: " + wrapInColoredFont(text,getTextColor(avg - otherAvg)) + wrapInColoredFont(text2,getTextColor(avg - otherAvg)));
