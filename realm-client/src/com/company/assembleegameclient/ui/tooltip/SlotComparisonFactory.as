   ...
   public class SlotComparisonFactory
   {
      ...
      public function SlotComparisonFactory()
      {
         ...
         this.hash[ItemConstants.SCEPTER_TYPE] = new ScepterComparison();
          this.hash[ItemConstants.LUTE_TYPE] =  projectileComparison;
          this.hash[ItemConstants.SHEATH_TYPE] =  projectileComparison;
          this.hash[ItemConstants.WAKI_TYPE] =  projectileComparison;
