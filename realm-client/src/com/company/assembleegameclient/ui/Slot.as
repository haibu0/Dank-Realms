package com.company.assembleegameclient.ui
{
   ...
   public class Slot extends Sprite
   {
      ...
      public static const SHURIKEN_TYPE:int = 24;
       ...
       public static const LUTE_TYPE:int = 26;

       public static const SHEATH_TYPE:int = 27;

       public static const WAKI_TYPE:int = 28;
         ...
         switch(this.type_)
         {
            ...
            case SCEPTER_TYPE:
               bd = AssetLibrary.getImageFromSet("lofiObj6",192);
                 break;
             case LUTE_TYPE:
                 bd = AssetLibrary.getImageFromSet("lofiObj6",0xd0);
                 break;
             case SHEATH_TYPE:
                 bd = AssetLibrary.getImageFromSet("lofiObj6",0xe0);
             case WAKI_TYPE:
                 bd = AssetLibrary.getImageFromSet("lofiObj6",256);
         }
